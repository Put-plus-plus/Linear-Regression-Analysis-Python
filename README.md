...
The data `regression_data.csv` used in the example below is a modified version of the data in Lichtinghagen,Ralf, Klawonn,Frank, and Hoffmann,Georg. (2020). HCV data. UCI Machine Learning Repository. https://doi.org/10.24432/C5D612. A selection of variables has been made, and the format of the original data has been changed and erronous values have been introduced so to illustrate the data cleaning capabilities of the above described methods.
